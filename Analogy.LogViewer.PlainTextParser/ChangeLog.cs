...
namespace Analogy.LogViewer.PlainTextParser
{
    public static class ChangeLog
    {
        ...
        {
            yield return new AnalogyChangeLog("Use Analogy.LogViewer.Template as base implementation", AnalogChangeLogType.Improvement, "Lior Banai", new DateTime(2020, 10, 06), "");
